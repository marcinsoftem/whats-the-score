...
export const translations = {
  pl: {
    ...
    auth: {
      ...
      forgotPasswordDesc: "Podaj swój e-mail, aby otrzymać 8-cyfrowy kod weryfikacyjny.",
      ...
      linkSent: "Wysłaliśmy 8-cyfrowy kod na Twój adres e-mail!",
  ...
  en: {
    ...
    auth: {
      ...
      forgotPasswordDesc: "Enter your email to receive an 8-digit verification code.",
      ...
      linkSent: "We've sent an 8-digit code to your email address!",
