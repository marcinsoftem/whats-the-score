...
export const translations = {
  pl: {
    ...
    players: {
      ...
      nickname: "Imię",
      clickToRandomize: "KLIKNIJ, ABY ZMIENIĆ",
      createVirtualTitle: "STWÓRZ GRACZA",
      editPlayerTitle: "EDYTUJ GRACZA",
      nicknameCharLimit: "Imię może mieć max 10 znaków",
      alreadyExists: "Gracz o takim nicku już istnieje",
      saveChanges: "ZAPISZ ZMIANY",
      createPlayer: "STWÓRZ GRACZA",
  ...
  en: {
    ...
    players: {
      ...
      nickname: "Nickname",
      clickToRandomize: "CLICK TO CHANGE",
      createVirtualTitle: "CREATE PLAYER",
