  ...
  pl: {
    ...
    auth: {
      ...
      errors: {
        ...
        emailNotConfirmed: "Adres e-mail nie został jeszcze potwierdzony",
        rateLimit: "Zbyt wiele prób logowania. Odczekaj chwilę.",
        ...
        emailTaken: "Ten adres e-mail jest już zarejestrowany. Przejdź do logowania.",
      },
      forgotPassword: "Zapomniałeś hasła?",
      forgotPasswordTitle: "ODZYSKAJ HASŁO",
      forgotPasswordDesc: "Podaj swój e-mail, aby otrzymać 6-cyfrowy kod weryfikacyjny.",
      resetPasswordButton: "WYŚLIJ KOD",
      resetPasswordTitle: "USTAW NOWE HASŁO",
      resetPasswordDesc: "Wprowadź swoje nowe hasło poniżej.",
      newPassword: "Nowe hasło",
      confirmPassword: "Potwierdź hasło",
      newPasswordPlaceholder: "Wpisz nowe hasło",
      confirmPasswordPlaceholder: "Powtórz nowe hasło",
      saveNewPasswordButton: "USTAW HASŁO",
      linkSent: "Wysłaliśmy 6-cyfrowy kod na Twój adres e-mail!",
      ...
      signUpSuccessDesc: "Wysłaliśmy 6-cyfrowy kod weryfikacyjny na Twój adres e-mail. Przy pierwszym logowaniu wprowadź go, aby aktywować konto.",
      resendCode: "WYŚLIJ KOD PONOWNIE",
      codeResent: "Nowy kod został wysłany na Twój e-mail.",
    ...
    settings: {
      ...
      pwaIos: "Dotknij 'Udostępnij' i 'Do ekranu początkowego'",
      pwaAndroid: "Dotknij 'Menu' (trzy kropki) i 'Zainstaluj aplikację'",
  ...
  en: {
    ...
    auth: {
      ...
      errors: {
        ...
        emailNotConfirmed: "Email address not confirmed yet",
        ...
        emailTaken: "This email address is already registered. Please go to login.",
      },
      forgotPassword: "Forgot password?",
      forgotPasswordTitle: "RECOVER PASSWORD",
      forgotPasswordDesc: "Enter your email to receive a 6-digit verification code.",
      resetPasswordButton: "SEND CODE",
      ...
      saveNewPasswordButton: "SET PASSWORD",
      linkSent: "We've sent a 6-digit code to your email address!",
      passwordChanged: "Password changed successfully! You can now log in.",
      passwordsDoNotMatch: "Passwords do not match",
      signUpSuccessTitle: "ACCOUNT CREATED!",
      signUpSuccessDesc: "We've sent a 6-digit verification code to your email. Enter it upon your first login to activate your account.",
    ...
    settings: {
      ...
      pwaIos: "Tap 'Share' and 'Add to Home Screen'",
      pwaAndroid: "Tap 'Menu' (three dots) and 'Install app'",
